...
#ifndef YinchengCoin_TEST_SCRIPTNUM10_H
#define YinchengCoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from YinchengCoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // YinchengCoin_TEST_BIGNUM_H
