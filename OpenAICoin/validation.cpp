...
#if defined(NDEBUG)
# error "YinchengCoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "YinchengCoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache, bool test_accept)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s YCC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("YinchengCoin-scriptch");
