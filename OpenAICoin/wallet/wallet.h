...
#ifndef YinchengCoin_WALLET_WALLET_H
#define YinchengCoin_WALLET_WALLET_H
...
public:
     ...
     * on this YinchengCoin node, and set to 0 for transactions that were created
...
#endif // YinchengCoin_WALLET_WALLET_H
