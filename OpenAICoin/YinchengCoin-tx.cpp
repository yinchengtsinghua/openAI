...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf(_("%s YinchengCoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  YinchengCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded YinchengCoin transaction") + "\n" +
              "  YinchengCoin-tx [options] -create [commands]   " + _("Create hex-encoded YinchengCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded YinchengCoin transaction
