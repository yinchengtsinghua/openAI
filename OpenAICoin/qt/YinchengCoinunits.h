...
#ifndef YinchengCoin_QT_YinchengCoinUNITS_H
#define YinchengCoin_QT_YinchengCoinUNITS_H
...
/** YinchengCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class YinchengCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit YinchengCoinUnits(QObject *parent);

    /** YinchengCoin units.
      @note Source: https://en.YinchengCoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        YCC,
...
typedef YinchengCoinUnits::Unit YinchengCoinUnit;

#endif // YinchengCoin_QT_YinchengCoinUNITS_H
