...
#ifndef YinchengCoin_QT_SPLASHSCREEN_H
#define YinchengCoin_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. YinchengCoin Core initialization
...
#endif // YinchengCoin_QT_SPLASHSCREEN_H
