...
#ifndef YinchengCoin_QT_WALLETMODEL_H
#define YinchengCoin_QT_WALLETMODEL_H
...
/** Interface to YinchengCoin wallet from Qt view code. */
...
#endif // YinchengCoin_QT_WALLETMODEL_H
