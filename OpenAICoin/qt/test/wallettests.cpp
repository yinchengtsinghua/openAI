...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<YinchengCoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_YinchengCoin-qt -platform xcb      # Linux
//     src/qt/test/test_YinchengCoin-qt -platform windows  # Windows
//     src/qt/test/test_YinchengCoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = YinchengCoinUnits::formatWithUnit(unit, balance, false, YinchengCoinUnits::separatorAlways);
    ...
    // Amount input
    YinchengCoinAmountField* amountInput = receiveCoinsDialog.findChild<YinchengCoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: YinchengCoin:")) != -1);
