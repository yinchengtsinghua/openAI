// Copyright (c) 2018 The YinchengCoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef YinchengCoin_INTERFACES_NODE_H
#define YinchengCoin_INTERFACES_NODE_H
...
//! Top-level interface for a YinchengCoin node (YinchengCoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // YinchengCoin_INTERFACES_NODE_H
